  ...
  return (
    <div className="flex">
      ...
      <div className={`main-content ${isCollapsed ? "expanded" : ""}`}>
        <h1 style={{ marginTop: "80px" }}>Create New Assignment</h1>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <input type="date" id="assignedDate" value={assignedDate} onChange={(e) => setAssignedDate(e.target.value)} required />
          </div>
          <div>
          ...
          <div>
            ...
            <select id="selectedClass" value={selectedClass} onChange={(e) => setSelectedClass(e.target.value)} required>
          ...
          <div>
            ...
            <textarea id="evaluationCriteria" placeholder="Enter evaluation criteria for AI grading" value={evaluationCriteria} onChange={(e) => setEvaluationCriteria(e.target.value)} required />
          </div>
